...
MarlinsLogoBadPixels = [Pixel(7, 0), Pixel(7, 1), Pixel(7, 2), Pixel(7, 3), Pixel(6, 5), Pixel(5, 6), Pixel(3, 7), Pixel(2, 8), Pixel(1, 8), Pixel(1, 13),
                        Pixel(1, 13), Pixel(2, 13), Pixel(2, 17), Pixel(2, 21), Pixel(2, 24), Pixel(1, 25)]
MetsLogoBadPixels = []
