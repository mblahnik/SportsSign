...
TigersLogoBadPixels = [Pixel(3, 0), Pixel(4, 0), Pixel(5, 1), Pixel(6, 1), Pixel(
    ...
    Pixel(13, 14), Pixel(11, 18), Pixel(12, 18), Pixel(13, 18), Pixel(14, 18), Pixel(
        15, 0), Pixel(18, 0), Pixel(12, 19), Pixel(12, 20), Pixel(11, 21), Pixel(13, 21),
...
TwinsLogoBadPixels = [Pixel(1, 1), Pixel(1, 2), Pixel(1, 3), Pixel(1, 4), Pixel(1, 5), Pixel(2, 6), Pixel(2, 7), Pixel(11, 4), Pixel(10, 4), Pixel(9, 5), Pixel(8, 5),
                      Pixel(7, 5), Pixel(7, 5), Pixel(6, 7), Pixel(5, 8), Pixel(4, 9), Pixel(
                          3, 10), Pixel(2, 11), Pixel(1, 12), Pixel(3, 9), Pixel(4, 8), Pixel(7, 6),
                      Pixel(0, 18), Pixel(1, 18), Pixel(1, 19), Pixel(2, 19), Pixel(1, 17), Pixel(23, 4), Pixel(
                          24, 4), Pixel(25, 5), Pixel(26, 5), Pixel(27, 6), Pixel(28, 7), Pixel(30, 7),
                      Pixel(30, 6), Pixel(29, 8), Pixel(30, 9), Pixel(12, 18), Pixel(12, 17), Pixel(
                          12, 16), Pixel(12, 15), Pixel(12, 14), Pixel(12, 13), Pixel(12, 12), Pixel(12, 11),
                      Pixel(13, 18), Pixel(19, 3), Pixel(13, 3), Pixel(11, 12), Pixel(10, 13), Pixel(
                          9, 14), Pixel(8, 15), Pixel(9, 15), Pixel(9, 16), Pixel(10, 17), Pixel(11, 18),
                      Pixel(2, 20), Pixel(3, 20), Pixel(3, 21), Pixel(4, 21), Pixel(4, 22), Pixel(
                      ...
                      Pixel(19, 11), Pixel(20, 11), Pixel(20, 12), Pixel(20, 13), Pixel(20, 14), Pixel(
                          20, 15), Pixel(20, 16), Pixel(20, 17), Pixel(20, 18), Pixel(20, 19),
...
YankeesLogoBadPixels = [Pixel(0, 6), Pixel(1, 5), Pixel(2, 4), Pixel(
    ...
    Pixel(10, 4), Pixel(16, 2), Pixel(19, 17), Pixel(18, 16), Pixel(18, 15), Pixel(5, 4), Pixel(
    ...
    Pixel(19, 25), Pixel(19, 26), Pixel(20, 30), Pixel(20, 29), Pixel(20, 28), Pixel(
        10, 28), Pixel(25, 29), Pixel(27, 29), Pixel(21, 0), Pixel(22, 1),
    Pixel(29, 26), Pixel(28, 25), Pixel(20, 8), Pixel(25, 4), Pixel(25, 5), Pixel(
        26, 4), Pixel(23, 4), Pixel(23, 5), Pixel(24, 4), Pixel(27, 26),
...
RockiesLogoBadPixels = [Pixel(10, 0), Pixel(11, 0), Pixel(12, 0), Pixel(7, 1), Pixel(
    ...
    Pixel(14, 30), Pixel(15, 30), Pixel(16, 30), Pixel(20, 30), Pixel(
        21, 30), Pixel(22, 30), Pixel(23, 30), Pixel(24, 30),
    Pixel(26, 27), Pixel(15, 24), Pixel(15, 23), Pixel(16, 23), Pixel(17, 25), Pixel(18, 3), Pixel(
        18, 4), Pixel(18, 5), Pixel(14, 9), Pixel(13, 8), Pixel(13, 7), Pixel(13, 6), Pixel(12, 6),
    Pixel(11, 6), Pixel(10, 6), Pixel(9, 7), Pixel(9, 8), Pixel(9, 9), Pixel(9, 10), Pixel(8, 13), Pixel(
        9, 12), Pixel(10, 12), Pixel(9, 13), Pixel(10, 13), Pixel(10, 14), Pixel(10, 15), Pixel(9, 15),
    Pixel(17, 17), Pixel(23, 24), Pixel(23, 23), Pixel(22, 23), Pixel(22, 22), Pixel(19, 10), Pixel(
        20, 10), Pixel(21, 11), Pixel(22, 12), Pixel(23, 13), Pixel(24, 15), Pixel(24, 16),
    Pixel(24, 17), Pixel(24, 18), Pixel(23, 19), Pixel(22, 20), Pixel(21, 21), Pixel(16, 14), Pixel(17, 15), Pixel(17, 14)]
