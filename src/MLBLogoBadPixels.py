...
WhiteSoxLogoBadPixels = [Pixel(3, 0), Pixel(2, 1), Pixel(1, 2), Pixel(
    0, 3), Pixel(0, 4), Pixel(0, 10), Pixel(1, 11), Pixel(1, 12), Pixel(2, 13), Pixel(2, 12), Pixel(3, 13), Pixel(1, 14), Pixel(0, 15), Pixel(0, 22), Pixel(1, 22), Pixel(2, 22), Pixel(3, 21), Pixel(4, 21), Pixel(5, 21), Pixel(8, 25),
